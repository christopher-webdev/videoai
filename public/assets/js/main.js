(function (window, document, $, undefined) {
    ...
    var cashvipeJs = {
        ...
        methods: function (e) {
            cashvipeJs.smothScroll();
            cashvipeJs.counterUpActivation();
            cashvipeJs.wowActivation();
            cashvipeJs.headerTopActivation();
            cashvipeJs.headerSticky();
            cashvipeJs.salActive();
            cashvipeJs.popupMobileMenu();
            cashvipeJs.popupDislikeSection();
            cashvipeJs.popupleftdashboard();
            cashvipeJs.popuprightdashboard();
            cashvipeJs.preloaderInit();
            cashvipeJs.showMoreBtn();
            cashvipeJs.slickSliderActivation();
            cashvipeJs.radialProgress();
            cashvipeJs.contactForm();
            cashvipeJs.menuCurrentLink();
            cashvipeJs.onePageNav();
            cashvipeJs.selectPicker();
        },
        ...
        preloaderInit: function(){
            cashvipeJs._window.on('load', function () {
...
function generateAutoReply() {
    ...
    return `cashvipe: I'm a dynamic chat bot!`;
  }
  ...
  function sendMessage() {
    ...
    if (welcomeMessageIndex < welcomeMessages.length) {
      const welcomeMessageElement = createMessageWithReactions('cashvipe', welcomeMessages[welcomeMessageIndex], 'ai-speech', 'assets/images/team/avater.png');
      appendMessage(welcomeMessageElement);
      welcomeMessageIndex++;
    } else {
      const autoReply = generateAutoReply();
      const autoReplyElement = createMessageWithReactions('cashvipe', autoReply, 'ai-speech', 'assets/images/team/avater.png');
  ...
  function saveAndRegenerateMessage(button) {
    ...
    const regeneratedMessageElement = createMessageWithReactions('cashvipe', regeneratedMessage, 'ai-speech', 'assets/images/team/avater.png');
